                ...
                <tbody>
                    @foreach($getAllPatientsInCategorys as $key => $testPerformed)
                        <tr>
                            ...
                            <td>
                                    <a class="btn btn-xs btn-primary" href="{{ route('catagory-show', $testPerformed->id) }}">
                                        {{ trans('global.view') }}
                                    </a>

                                    <a class="btn btn-xs btn-info" href="{{ route('catagory-edit', $testPerformed->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                            

                                    <form  method="POST" action="{{ route("catagory-delete", [$testPerformed->id]) }}" onsubmit="return confirm('{{ trans('Are You Sure to Deleted  ?') }}');"  style="display: inline-block;">
