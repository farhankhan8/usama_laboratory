                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @elseif ($test->Sname_id =='2')
                                <button class="btn btn-xs btn-primary">Verified</button>
                              @elseif ($test->Sname_id =='3')
                                <button class="btn btn-xs  btn-warning">Not Received</button>
                              @elseif ($test->Sname_id =='4')
